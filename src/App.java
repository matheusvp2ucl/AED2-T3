...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < palavra.length(); i++) {
            ...
            // Se retornar null, iremos criar o caracter e inserir ja para a contagem da frequencia
            // Se não retornar null, ele vai retornar o obj Node do caracter e somar mais 1 no atributo freq do objeto !
            if (obj == null) {
        ...
        // De acordo com a regra do Algoritimo de Huffman, pegando os 2 caracteres de menor frequencia da lista
        // retornando e somando para criar uma arvore com os dois e inserindo no final da lista com valor, assim ate
        ...
        // Função recusiva para conseguir mapear o binario pela frequencia da arvore criada !
